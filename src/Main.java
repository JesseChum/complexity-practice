...
public class Main {
  ...
  // YOUR ANSWER HERE O(n^2) theres something off about this method
  ...
  // YOUR ANSWER HERE Time complexity O(n)
  ...
  // YOUR ANSWER HERE Using a Hashmap should be the best option. This is efficient for fast updates/look ups
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE ArrayList should the best option. This allows efficency to additions at end 
  // and random access
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE I think a linkedlist should be the best option. It maintains the insertion order
  //and allows additions and removals
}